...
if (isset($_GET['delete_posting'])) {
  $id = $_GET['delete_posting'];
  $sql = "DELETE FROM posting WHERE id=$id";

  if ($koneksi->query($sql) === TRUE) {
      echo "Posting berhasil dihapus.";
  } else {
...
<div class="container mt-4">
        <div class="row">
            <div class="col-lg-8">
<a href="../input_post.php" class="btn btn-primary mb-4">BUAT ARTIKEL TERBARU</a>
...
echo $string;
        ?></p>
         ...
         <a href="?delete_posting=<?php echo $row['id'];?>" class="btn btn-danger">HAPUS</a>
         <a href="../edit_post.php?id=<?php echo $row['id'];?>" class="btn btn-warning">EDIT POSTINGAN</a>
      </div>
    </div>
  </div>
</div>
